            ...
            <div class="content">
                ...
                <div class="poster">
                    ...
                    <p class="list-text">For accepted abstracts, authors must submit an e-poster via the official
                        website of the CMAAS 2026. E-posters will be displayed at the event venue. </p>
                    <ul class="disc-list">
                        ...
                        <li><b>Submission Method:</b> Please <nuxt-link class="link" to="/login">log in</nuxt-link> to
                            ...
                            CMAAS 2026 to upload your e-poster. </li>
                    </ul>
                ...
                <div class="video">
                    ...
                    <p class="list-text"><b>For accepted abstracts, authors must submit a video file via the official
                            website of the CMAAS 2026. Videos will be displayed at the event venue. </b>
                    </p>
                    <ul class="disc-list">
                        <li class="note-text"><b>Video Submission Deadline:</b> Monday, September 21, 2026, 23:59 (local
                            time) </li>
                        <li><b>Submission Method: </b>Please log in to the official website of the CMAAS 2026 to upload
                            the video. </li>
                    </ul>
...
useSeoMeta({
    title: 'Presentation Guidelines - CMAAS 2026  ',
    description: 'Learn about the presentation guidelines for the CMAAS 2026  . Understand the requirements for oral presentations, posters, and videos.',
    keywords: 'Presentation Guidelines,CMAAS,CMAAS 2026,2026 CMAAS'
})
